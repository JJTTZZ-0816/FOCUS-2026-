...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    g1 = player_score % 10
    g2 = (opponent_score // 10) % 10
    return max(3*abs(g1-g2),1)
    # END PROBLEM 2
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    """
    # BEGIN PROBLEM 4
    g = simple_update(num_rolls, player_score, opponent_score, dice)
    return sus_points(g)
    # END PROBLEM 4
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    """
    # BEGIN PROBLEM 9
    averaged_score = make_averaged(roll_dice,times_called)
    best_num_rolls = 1
    best_score = averaged_score(1,dice)
    for num_rolls in range(2,11):
        current_score = averaged_score(num_rolls,dice)
